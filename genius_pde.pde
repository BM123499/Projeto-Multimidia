...
void setup() {
  ...
  SF = new SoundFile[] {new SoundFile(this, "1.wav"), new SoundFile(this, "2.wav"), new SoundFile(this, "3.wav"), new SoundFile(this, "4.wav"),
                        new SoundFile(this, "5.wav"), new SoundFile(this, "6.wav"), new SoundFile(this, "7.wav")};
}
